...
<center><h1 class="title-center">Introducing Tutor Duy Le</h1>
</center>
<br>
...
<div class="row">
  <div class="column">
    <div class="card">
	<!--get tutor's picture-->
      <img src="DUYLE.PNG" alt="duy" style="width:100%">
      <div class="container">
	  <!--finishing up the tutor's card-->
        ...
        <p>I'm Duy Le, and I'm from Vietnam. I love helping people having trouble with Math, Computer Science, Physics. I love watching Japanese animation, and I feel interested in all the thing which make sense. I love animals and gentle ladies.</p>
       
        <p><button class="button">led27@mycu.concord.edu</button></p
